<%@ Page Title="Directores" Language="C#" MasterPageFile="~/SiteMES.Master" AutoEventWireup="true" CodeBehind="Directores.aspx.cs" Inherits="MSESP.Directores" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            jQuery("#jQGridDemo").jqGrid({
                url: 'jqGridDirectores.ashx',
                datatype: "xml",
                colNames: ['Nombre', 'Email', 'Región', '', ''],
                colModel: [
                            { name: 'NOMBRE', index: 'NOMBRE', width: 150, stype: 'text' },
                            { name: 'EMAIL', index: 'EMAIL', width: 100, stype: 'text' },
        ...
        function validarFrm() {
            validator = $("#form1").validate({
                ...
                messages: {
                    ctl00$MainContent$txtRazon: "&bull; Ingrese Nombre del Director.",
                    ctl00$MainContent$solRegEmp: "&bull; Seleccione Región.",
                    ctl00$MainContent$txtEmail: {
                        required: "&bull; Ingrese Email de Director.",
                        email: "&bull; Email de Director erroneo."
                    }
                }
            });
        }
        ...
        function actualizar(i) {
            $.ajax({
                type: "GET",
                url: "datosDirectores.ashx", //Direccion del servicio web segido de /Nombre del metodo a llamar
    ...
    <form id="form1" runat="server" class="cmxform">
        <asp:Table ID="Table1" runat="server">
            <asp:TableRow>
                ...
                <asp:TableCell Width="600"><asp:TextBox runat="server" ID="txtRazon" Width="50%" MaxLength="50"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>Email : </asp:TableCell>
                <asp:TableCell><asp:TextBox runat="server" ID="txtEmail" Width="30%" MaxLength="50"></asp:TextBox></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
