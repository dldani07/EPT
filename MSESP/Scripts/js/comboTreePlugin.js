...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.init = function () {
        ...
        //this._elemArrowBtn = $('<span class="comboTreeArrowBtnImg">▼</span>');
        this._elemArrowBtn = $('<span id="' + this.comboTreeId + 'ArrowBtn" class="comboTreeArrowBtn" style="width:22px;"><center><span class="comboTreeArrowBtnImg">▼</span></center></span>');
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        if (this.options.isMultiple)
            itemHtml += '<span data-id="' + sourceItem.id + '" class="comboTreeItemTitle"><input type="checkbox" id="' + 'chk-' + sourceItem.id +'">' + sourceItem.title + '</span>';
        else
