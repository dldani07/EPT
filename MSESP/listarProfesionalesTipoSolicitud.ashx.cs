...
namespace MSESP
{
    ...
    /// </summary>
    public class listarProfesionalesTipoSolicitud : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string xml = "", idprofSel = "", Proyecto = "", ProvRegion="";
            ...
            {
                ProvRegion = " and pr.ID_REGION = " + context.Request["r"];
            }
            

            DataSet dsQuery = fn.dsSql("SELECT DISTINCT s.ID_PROFESIONAL,NOMBRE=dbo.MayMinTexto(s.NOMBRE)/*,s.REALIZA,EPT=item*/ " +
                                       ...
                                       " where tp.ID_TIPO_SOLICITUD in (" + context.Request["t"] + ")) and PP.estado=1 and s.estado2='A' " + Proyecto + ProvRegion +
                                       " order by NOMBRE");
